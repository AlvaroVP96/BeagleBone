...
Todo el código fuente, documentación y recursos utilizados en este proyecto están 
disponibles públicamente en el repositorio de GitHub:

\begin{center}
\texttt{https://github.com/AlvaroVP96/BeagleBone}
\end{center}
